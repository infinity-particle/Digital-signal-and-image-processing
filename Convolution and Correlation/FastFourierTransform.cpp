...
QVector<complex<double>> *FastFourierTransform::transform(const QVector<complex<double>> &data)
{
    if (data.size() == 1) {
...
QVector<complex<double> > *FastFourierTransform::directTransform(const QVector<complex<double> > &data)
{
    additionCounter = 0;
    multiplyCounter = 0;
...
QVector<complex<double> > *FastFourierTransform::directTransform(const QVector<double> &data)
{
