...
QVector<complex<double>>* DiscreteFourierTransform::inverseTransform(const QVector<complex<double>> &data)
{
    QVector<complex<double>> *result = new QVector<complex<double>>(data.size());
...
QVector<double>* DiscreteFourierTransform::getAmplitude(const QVector<complex<double>> &numbers)
{
...
QVector<double> * DiscreteFourierTransform::getPhase(const QVector<complex<double>> & numbers)
{
    QVector<double> *result = new QVector<double>(numbers.size());
    for (int i=0;i<numbers.size();i++) {
